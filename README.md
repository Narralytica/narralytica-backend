...
The service-role key is backend-only. Never expose it in the website repo or browser code.
...
- `src/` contains older backend code kept for reference while the terminal pipeline stabilizes.
- Keep provider keys, Supabase service credentials, and generated runtime files out of commits.
